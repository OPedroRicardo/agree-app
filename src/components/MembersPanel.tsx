  ...
  return (
    <div
      ...
      className={`flex flex-none overflow-hidden transition-[width,opacity,transform] duration-300 ease-out ${
        open ? 'w-[220px] translate-x-0 opacity-100' : 'w-0 translate-x-3 opacity-0'
      }`}
      style={{
    ...
    >
      <div className="flex w-[220px] flex-none flex-col items-center gap-3 overflow-y-auto p-4 text-center">
